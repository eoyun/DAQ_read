...
int main(int argc, char* argv[]){
	...
	sprintf(file_name,"/u/user/eoyun/DAQ/25.03.27/DAQ_read/time_calib/global_MID_%d_ch_%d_loop_%d_add.txt",mid,ch,loops);
	...
	fclose(fp);
	TFile* f_root = new TFile(Form("./roots/251016_add/pt_test_global_%d_loop_%d_add.root",runnum,loops),"recreate");
